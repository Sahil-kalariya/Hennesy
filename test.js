...
//       try {
//         const resultContent = await fetchResultFromS3(resultS3Uri);
//         console.log("Successfully fetched result from S3");
        
//         // Store the extracted data in the request object for the next middleware
//         req.extractedData = resultContent;
        
//         // Continue to the next middleware (dataValidator)
//         next();
//       } catch (s3Error) {
...
//     // Return the inference result for storage in req.extractedData
